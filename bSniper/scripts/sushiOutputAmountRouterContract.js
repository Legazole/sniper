...
async function main() {
    ...
    */
    ...
    const UNI_FACTORY_ADDRESS = await sushiRouter.factory()
    ...
    */
    ...
    console.log(
        `Calculated amountOut: USDC for given reserves and amountIntoNewReserves: ${ethers.utils.formatEther(
            amountIntoInputToken
        )} : LINK`
    )
    const amountOut = await sushiRouter.getAmountOut(
        amountIntoInputToken,
